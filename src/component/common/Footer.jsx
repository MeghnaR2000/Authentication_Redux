          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 footer-contact">
                <h3>TECH CARE</h3>
                <p>
                BENGAL ECO INTELLIGENT PARK, Plot No. 3, EM Block, Sector V, Bidhannagar, Kolkata, West Bengal 700091
                  <strong>Phone:</strong> 03325808641<br />
                  <strong>Email:</strong> info@techcare.ac.in<br />
                </p>
              </div>
              ...
              <div className="col-lg-4 col-md-6 footer-newsletter">
                ...
                <p>Receive news and best course offers by email from Tech Care. You can unsubscribe whenever you want, it is totally free</p>
        ...
        <div className="container d-md-flex py-4">
          ...
          <div className="mr-md-auto text-center text-md-left">
            ...
            <div className="credits">
              Designed by <a href="https://bootstrapmade.com/">Meghna Roy</a>
            </div>
          </div>
